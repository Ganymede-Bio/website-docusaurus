...
On the local PC where the agent will be installed, sign into your tenant (as described in [step 1](#step-1-sign-into-ganymede)) and download the installer for the agent for your operating system by hovering over the <div className="button dark_gray_button"><DownloadOutlined /> Download</div> button and selecting your OS.  For this demo, we will be using a Windows PC, so we will download the Windows installer.

Once downloaded, run the executable to install the agent.


<div class="text--center">
<img alt="Agent download" src="https://ganymede-bio.mo.cloudinary.net/agent/GanymedeAgentSetup_20240125.png"/>
</div>
&nbsp;

<div class="text--center">
<img alt="Agent download" src="https://ganymede-bio.mo.cloudinary.net/agent/GanymedeAgentInstallationLocation_20240125.png"/>
</div>
&nbsp;


<div class="text--center">
<img alt="Agent download" src="https://ganymede-bio.mo.cloudinary.net/agent/GanymedeAgentInstallScreen_20240125.png"/>
</div>
&nbsp;

<div class="text--center">
<img alt="Agent download" src="https://ganymede-bio.mo.cloudinary.net/agent/GanymedeAgentCompleteSetup_20240125.png"/>
</div>
&nbsp;
