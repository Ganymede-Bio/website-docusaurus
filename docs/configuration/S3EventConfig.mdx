---
id: S3EventConfig
title: Configuring S3 Events
displayed_sidebar: webUiSidebar
---

Ganymede Flows can be triggered on file save to an S3 bucket; this enables processing to occur on files as soon as they land in a configured S3 bucket.  This page details the configuration required to enable this.
...
3. Enter the API Key configured in step 2.iv into a secret named **s3_api_key** the [Environment Secrets](../AdminControls#environment-secrets) panel.
