...
On the right-side panel of the Okta application window, there is a link to SAML setup. The fields above can be found in that window. Please send this information to Ganymede via email or your security questionnaire.
