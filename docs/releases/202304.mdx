...
- [Ganymede SDK](../api/GanymedeSDKOverview.mdx) now has convenience functions for listing and retrieving files and tables within the editor notebook environment
