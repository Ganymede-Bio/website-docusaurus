...
**Features**
- **UI**: Connection details are now visible and editable in the UI
...
**Improvements**
- **UI**: Users in the environment list are now sorted properly
...
- **Flows**: The [send_email method](../api/GanymedeClass#method-send_email) is now testable in notebooks. No email will be sent while testing, an HTML rendering of the email will be displayed
