...
- **Flows**: The [send_email function](../api/GanymedeClass#method-send_email) is now testable in notebooks. No email will be sent while testing, an HTML rendering of the email will be displayed
