...
**Features**
- **UI**: [Connection details](../connectivity/AgentMonitoring#monitoring-agent-connections) are now visible and editable in the UI
...
**Features**
- **UI**: [Flow history](../FlowEditor#flow-versions) is now viewable from within the Flow Editor
...
- **Flows**: The [send_email method](../sdk/GanymedeClass#method-send_email) is now testable in notebooks. No email will be sent while testing, an HTML rendering of the email will be displayed
...
- **UI**: File chip standardization
  ...
  - The file chip now supports navigation to the files table [within the tooltip](../FlowRuns)
