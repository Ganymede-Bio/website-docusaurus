...
**Improvements**
- Users can now [add a compensation matrix to a FlowJo workspace file](../sdk/sdk_markdowns/fcs#function-fcscreate_comp_matrix_xml) using the Ganymede SDK.
- Users can now generate a default pandera schema from a pandas dataframe via the [SchemaValidation class](../sdk/ContextVariables#class-schemavalidation) in Ganymede SDK.
...
### March 21 2024
**Improvements**
- Tables and files that are retrieved via the Ganymede SDK can now be cached in an editor notebook or analysis notebook. Future runs of the execute function during development iterations will pull from the cached objects instead of querying Ganymede.
