...
**Improvements**
- **UI**: The Flow Run table is now displayed even when no Flow is selected
- **SDK**: Added [statistical process control class with Western Electric rules](../sdk/markdowns/statistical_process_control.md)

**Agent Version**: 5.1.68
