...
### April 18 2024
**Features/Updates**
- A Benchling_Warehouse_Sync node type was added. This node type syncs Benchling Warehouse to Ganymede. 

**Improvements**
- The Lint cell and Save cell was replaced, with functionality moved to the Kernel menu.  The save button in the toolbar can also be used to save and commit pipeline code..
