...
**Improvements**
- The [Lint and Save cells were replaced, with functionality moved to the Kernel menu](../app/flows/NodeEditor#saving-and-deploying-pipeline-code).  The save button in the toolbar can also be used to save and commit pipeline code.
