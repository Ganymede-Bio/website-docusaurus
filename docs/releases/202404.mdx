...
### April 18 2024
**Features/Updates**
- A Benchling_Warehouse_Sync node type was added. This node type syncs the entire Benchling Warehouse to Ganymede by creating tables and appending all new records. 

**Improvements**
- The Lint cell and Save cell were both removed from editor notebooks since the Save button in notebooks now performs both of those actions.
