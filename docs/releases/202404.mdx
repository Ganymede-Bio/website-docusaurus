...
- The following node types are now available:
    - LC_Read: Processes an HPLC file
    - LC_Read_Multi: Processes a group of HPLC files
    - LCMS_Read: Processes an mzML file (mass spectrometric data format)
    - LCMS_Read_Multi: Processes a group of mzML files 
    - WSP_Read: Processes a FlowJo workspace file (.wsp)
