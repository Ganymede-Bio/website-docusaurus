...
### July 13 2023
**Features/Updates**
- An improved file browser is now available, which allows users to more easily find files related to their workflow. [See the File Browser documentation for more information on how to use it](app/files/FileBrowser.mdx).
