...
- **Agents**: Added _restart_cron_utc_ reserved variable for Windows Agents, which restarts the Windows service associated with an Agent at a specified UTC time.  
