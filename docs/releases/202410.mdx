...
**Features**
- **UI**: An [audit log](../app/configuration/AuditLog.mdx) is now available for all users to view the actions in an environment
...
- **Agent**: Notifications are available from within the Agent code
    ...
    - Call [agent_sdk.notify](../sdk/markdowns/AgentSDK.mdx) to send a notification to all subscribers
    - Notifications are displayed in the Connection logs
- **UI**: Flows can now be [copied](../app/flows/FlowEditor#copying-flows)
...
- **UI**: Code for prior commits can be viewed and quickly copied, for both [Flows](../app/flows/FlowEditor#historical-flow-versions) and [Agents](../app/agents/AgentMonitoring#viewing-historical-code)
