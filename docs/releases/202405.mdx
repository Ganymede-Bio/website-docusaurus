...
- **Notebooks**: The `help()` function is now available for notebooks in development environments available to query the documentation site and provide generated code examples.
