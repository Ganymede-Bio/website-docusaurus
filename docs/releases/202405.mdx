...
- **Notebooks**: Customers can now [customize the HTML template](../sdk/GanymedeClass#sending-emails-from-execute-function) when sending email alerts from user-defined code.
