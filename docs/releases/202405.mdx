...
### May 16 2024
**Improvements**
- Editor and agent notebooks will now commit and deploy code to pipelines when Ctrl+S or Cmd+S is pressed.
- Customers can now [customize the HTML template](../api/GanymedeClass#sending-emails-from-execute-function) when sending email alerts from user-defined code.
- NodeReturn table contents are no longer displayed as transposed.
