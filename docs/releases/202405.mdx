...
**Features/Updates**
- **Notebooks**: A [code](../api/AI.mdx#code-generation) function has been added to development environment notebooks to allow users to generate code replicating the function signature of the pipeline cell.
...
**Bug Fixes**
- **SDK**: Fixed an issue in the [create_assay_results_from_dataframe](../api/markdowns/benchling.benchling#function-benchlingcreate_assay_results_from_dataframe) function where upload was failing on bulk upload.
...
- **Notebooks**: The `help()` function is now [available for notebooks in development environments](../api/AI#search-documentation) available to query the documentation site.
