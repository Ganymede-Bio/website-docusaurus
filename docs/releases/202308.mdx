...
### August 31 2023
**Features/Updates**
- The logged-in user’s email is now displayed in the header navigation bar.

**Improvements**
- The Flow Runs logs drawer now has a shareable URL and improved back and forth navigation.
- In the navigation bar dropdown, a user can now copy the application version number to their clipboard, for debugging and validation purposes.

**Bug Fixes**
- Nodes will only write to output storage once, so that output files no longer appear in duplicate.
