...
### October 12 2023
**Features/Updates**
- Allotrope ADM validation schemas are now available in the Validation class of the Ganymede SDK.
- Sending email notifications from within a Flow is now possible by using the GanymedeEmailAlert class in the Ganymede SDK.
