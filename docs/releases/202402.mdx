...
### February 15 2024
**Features/Updates**
- Flow results can now be used as inputs to downstream Flows.
- A Benchling_Warehouse_Sync node type was added. This node can query the Benchling warehouse directly from the Ganymede SDK.

**Bug Fixes**
- The file tooltip now scrolls to display all files that are part of a group.
