...
**Bug Fixes**
- **Web UI**: Fixed an issue where Files page selections would be reset while Files are loading 
- **Flows**: Fixed an issue where very large File listing calls (>500k files) could cause the Flow Run to fail
- **Web UI**: Corrected the sort order of Analysis app sessions
...
- **Web UI**: Better track and organize entities in Ganymede using Processes, Unit Operations, and Instruments
    ...
    - See more about Processes, Unit Operations, and Instruments [here](../app/processes/Processes.mdx)
