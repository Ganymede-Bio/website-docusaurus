...
- A new method in Ganymede SDK, [get_last_run_input_files](../api/GanymedeClass#method-get_last_run_input_files), can be used to pull the most recent files that were input to a Flow.

**Improvements**
- The [WSP class](../api/markdowns/fcs) in the Ganymede SDK can now parse owning groups out of a WSP file.
...
- [Methods](../api/markdowns/benchling.benchling.md#function-benchlingarchive_custom_entity) for archiving Benchling custom entities and assay results are now available in Ganymede SDK
