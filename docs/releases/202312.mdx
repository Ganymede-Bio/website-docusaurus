...
**Bug Fixes**
- The Benchling method for updating custom entities now no longer updates folder location of hte custom entity by default.
...
**Improvements**
- The [WSP class](../sdk/markdowns/fcs) in the Ganymede SDK can now parse owning groups out of a WSP file.
...
### December 7 2023
**Features/Updates**
- [Flow Run errors](../app/flows/FlowView.mdx#error-attribution) can now be attributed to validation, connection, function, or platform errors. These errors can be customized and raised in user-defined code by using the Ganymede Exceptions class in the Ganymede SDK. Errors are displayed with a custom message, function, and line number at the top of the logs drawer.
- [Methods](../sdk/markdowns/benchling.benchling.md#function-benchlingarchive_custom_entity) for archiving Benchling custom entities and assay results are now available in Ganymede SDK
