...
- **Agents**: Agents installed on Windows at version 4.8 or later can now have their core version remotely updated
    ...
    - Ganymede tables can now be [queried from Agents](../sdk/markdowns/AgentModelsAndMethods#accessing-ganymede-tables-from-agents)
...
**Improvements**
- **UI**: Files page loading has been optimized for better performance
- **Agents**: Agents will have less delay between detecting a file and running a flow
- **UI**: Tag activity page has been updated to support paging and more efficient loading
- **Flows**: Performance for [list_files, retrieve_files, and related methods](../sdk/GanymedeClass#methods-for-accessing-files) have been optimized
