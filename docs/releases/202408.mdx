...
**Improvements**
- **Agents**: [File watcher Agents](../connectivity/Agent#watch-for-files-locally-then-run-flow) will have less delay between detecting a file and starting a flow with the detected file
...
- **UI**: [Tag activity page](../TagActivity.mdx) has been updated to support paging and more efficient loading
...
**Features**
- **UI**: You can now see the history of activities related to a given file [Tag](../connectivity/Tags.mdx)
    - Click on any Tag to see all activities in a [timeline view](../TagActivity.mdx)
