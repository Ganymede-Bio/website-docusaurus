...
**Improvements**
- **Agent**: Windows agents now also support MSI files for installation
- **Agent**: The agent core version is now displayed in editor notebooks
- **Agent**: Logs will be updated to the cloud more frequently

**Bug Fixes**
- **Agent**: An issue with creating One Shot agents has been fixed
