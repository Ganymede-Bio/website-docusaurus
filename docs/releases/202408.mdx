...
- **UI**: Self-service Integration Panel
    ...
    - Restrict network access while preserving Ganymede functionality by allowlisting the Ganymede IP addresses


**Improvements**
- **Agents**: Logging around log file rotation is now less noisy and more robust
- **Agents**: Leading and trailing whitespace in Connection variables is now removed
