...
- **UI**: Auto-logout for shared PCs
    - When signing in to a shared PC, select the shared computer option and you will be logged out of Ganymede when you close your browser tabs
