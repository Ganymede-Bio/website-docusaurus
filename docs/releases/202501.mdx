...
- **Agents**: Agents can now be configured to run as a specific user in Agent version 5.3.20 and later
  ...
  - See detailed setup instructions on the [Connection Details page](../app/agents/AgentInstall.mdx#step-4-if-desired-service-identity-setup)

**Improvements**
- **Agents**: Connections undergoing full update will appear as Online on the Connections page
- **Agents**: Connection cleanup logic has been improved when running uninstall and full update
