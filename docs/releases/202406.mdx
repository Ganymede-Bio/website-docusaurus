...
**Features**
- Flow documentation is now available in the Flow Editor
  - Users can add documentation to their flows by clicking on the "Documentation" tab in the Flow Editor Sidebar. The documentation is displayed in the Flow Info page, the Flow Editor sidebar, and on the Flow Card on the home page. 
...
- Flows can now be renamed and flow names now support spaces and special characters
