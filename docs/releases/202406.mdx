...
- **SDK**: Fixed [list_files method](../sdk/GanymedeClass#method-list_files), which was returning duplicate records when referencing a file that had been associated with multiple flow runs
...
- **Flow**: Flow documentation is now available in the Flow Editor
  - Users can [add documentation](../app/flows/FlowEditor#documenting-flows) to their flows by clicking on the "Documentation" tab in the Flow Editor Sidebar. The documentation is displayed in the Flow Info page, the Flow Editor sidebar, and on the Flow Card on the home page. 
