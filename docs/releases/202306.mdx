...
### June 23 2023
**Features/Updates**
- Agents are now available for use in all environments. They can be customized with user-defined code, and are downloadable as either Windows or Linux executables to run on instrument PCs. [See the Agent documentation to get started with using Agents](../app/agents/Agent.mdx).
