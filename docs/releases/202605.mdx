...
- **Modular Analysis (MA)**: MA Application version is now displayed directly on its card within the MA Application Gallery.
    - MA Application version follows the format "YYYYMMDD-HHmmssSSS", representing the most recent commit date time.
    - Newly-created apps (no commits yet) display a "Pending first commit" indicator in place of a version number.

![MA app card with version label](/img/20260522_ma_app_version.png)

![MA app card with pending first commit](/img/20260522_ma_app_pending.png)
