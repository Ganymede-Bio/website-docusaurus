...
- **Agents**: Windows Agents now automatically restart and reconnect after an unexpected shutdown or startup failure, eliminating the need for manual intervention when a lab PC reboots.
