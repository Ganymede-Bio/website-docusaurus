...
- **Agent**: Secrets can now be retrived from the agent_sdk
...
- **UI**: Fixed an issue where row counts of Tables were not accurate
- **UI**: Corrected a links to the Documentation site
...
- **API**: Agent executables can be [downloaded from the API](../api/download-agent.api.mdx)
