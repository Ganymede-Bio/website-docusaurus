...
### November 2 2023
**Features/Updates**
- Flows can now be assigned to specific users so that a curated list of My Flows appears on the [<div className="button darkblue_button"><HomeOutlined /> **Home**</div>](../app/Home.mdx) page. Admins can assign Flows to users from the Flow settings panel, or users can self-assign Flows from the All Flows tab.
