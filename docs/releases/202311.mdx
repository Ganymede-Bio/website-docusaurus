...
- A [retrieve_tables](../api/GanymedeClass.mdx#method-retrieve_tables) method was added to the Ganymede SDK, which retrieves tables, preserving special characters in table names. 
