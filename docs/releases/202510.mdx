...
**Features**
- **API**: Added a new [streaming data endpoint](/api#tag/Tables/streamData) to allow for real-time data processing. This endpoint will store data in a table (designated by TableId) that can be queried via the API or from Flows.
- **API**: Added a new endpoint for [modifying file tags](/api#tag/Files/modifyFileTags).
