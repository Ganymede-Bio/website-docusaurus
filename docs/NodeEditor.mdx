...
Available tables and their associated schemas can be observed in the [Data Explorer](./DataExplorer.mdx) tab of the Ganymede app or explored in [Dashboards](./Dashboards).
