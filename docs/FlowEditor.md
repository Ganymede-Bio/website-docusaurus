...
For each file uploaded, an optional run tag can be assigned from the dropdown menu labeled "Run Tag". These run tags are populated with the names that correspond to your entities in Benchling so that you can easily attribute files and write back to your ELN. We are able to enable this functionality with a simple intergration with your Benchling account. 

<img width="243" alt="Screen Shot 2022-10-07 at 9 08 48 AM" src="https://user-images.githubusercontent.com/46538575/194577607-286079c2-d2ab-4f3a-b8cb-c1ec969580db.png">
