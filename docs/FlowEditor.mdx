...
<img width="1124" alt="Settings" src="https://ganymede-bio.mo.cloudinary.net/apiServer/AddNewFlow_20230424.png"/>
...
Email notifications are sent to specified users upon _flow_ failure.
...
In order to delete _flows_, click the <div className="button darkblue_button">**Manage <SettingOutlined />**</div>Button on the Flow Editor page and which opens up the right sidebar offering a button to <div className="button black_button">Delete Flow</div>
