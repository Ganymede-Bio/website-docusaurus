...
<img alt="Add new flow" src="https://ganymede-bio.mo.cloudinary.net/apiServer/AddNewFlow_20230601.png"/>
...
#### Configuring Auto Run Trigger for Flow Runs

Flows can be configured to automatically run on a schedule. The schedule is set by selecting from the dropdowns shown below and can be configured in intervals of months, weeks, days, hours, and minutes. Note the schedule is set in UTC time.
