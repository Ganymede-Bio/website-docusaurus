...
To create a new _flow_, click the <div className="button darkblue_button">**Manage <SettingOutlined />**</div> button in the upper right hand corner of the screen. Then click the <div className="button black_button">Add New Flow</div> button on the sidebar.  This action exposes a modal for naming and describing the _flow_.  
