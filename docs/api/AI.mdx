...
will return a response from the GPT model with relevant information on the query.  Messages sent within a single notebook session will be incorporated into the same OpenAI Thread.
