...
Available tables and their associated schemas can be observed in the [Data Explorer](../tables/DataExplorer.mdx) tab of the Ganymede app or explored in [Dashboards](../dashboards/Dashboards.mdx).
