...
- In a cell, typing `save()` and then executing the cell.
...
:::info custom commit message

If you would like to submit a custom commit message, you can do so by typing `save(msg="Your custom commit message")` in a cell and executing it.
