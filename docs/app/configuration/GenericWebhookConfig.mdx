...
title: Configuring Webhook-Driven Flows
...
- API endpoint to deliver events to: https://your_subdomain.ganymede.bio/event/ENV_NAME/webhook
...
2. Verify that the `SECRET_NAME`: `SECRET_VALUE` key-value pair is present in the [Environment Administration panel](../admin/AdminControls.mdx).
