...
* In your repo go to Settings > Secrets & Variables > Actions and set a Github repo variable named GANYMEDE_SUBDOMAIN to the corresponding Ganymede subdomain value. If you log into Ganymede at https://mycompany.ganymede.bio, this would be mycompany
