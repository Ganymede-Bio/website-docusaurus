...
The File Browser allows users to filter and select data files by [Tags](app/files/Tags), which [Flows](app/flows/FlowEditor) and/or [Agents](app/agents/Agent), and other file attributes.
...
These tools offer different modes for exploring and visualizing data within Ganymede.
...
Virtualization allows users to insert manual processing steps into an automated workflow.
