...
To update a Connection, select the desired Connection in the Connections tab and click on the Edit Connection button.  You can update the following fields on a connection from the Ganymede UI:
