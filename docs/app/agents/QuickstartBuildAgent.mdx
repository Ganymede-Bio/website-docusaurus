...
Once the Agent build is complete, the associated installer will be available for download from the Agents subsection of the Connections pane. Find your newly created agent by entering it's name in the search bar.
