...
If you would like to download the Windows Agent through a script, you can do so [through the Ganymede API](/api#operation/downloadAgent).
...
If you would like to download the Linux Agent installer through a script, you can do so [through the Ganymede API](/api#operation/downloadAgent).
