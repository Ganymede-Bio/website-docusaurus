...
2. Configure any desired tags and labels for the Connection in the Ganymede UI, as described in the [Post-Installation Activities section](#post-installation-activities).
