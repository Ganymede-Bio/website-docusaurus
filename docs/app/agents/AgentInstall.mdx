...
5. Find your Agent and hover over the **Download** button. 
...
### Step 5: Set up Connection-Level Tags and Variables
...
3. Click <div className="button darkblue_outline_button"><PlusOutlined /> Add file tag</div> to add a file tag.
    1. Type in Connection variables as key: value pairs.
    2. Click Save to apply the tags to the Connections.  The tag will be visible under Connection file tags if properly applied.
...
6. Add Labels to the Connection with desired values.
