...
Documentation on the objects used in the user-defined code and additional examples can be found on the [Agent Data Models](../../sdk/markdowns/AgentSDK.mdx) page.
...
Additional examples can be found on the [Agent Models and Methods page](../../sdk/markdowns/AgentSDK#cron-agent)
