...
Iif you still do not see the Agent Connection in the Ganymede App, check the startup log in the folder that the Agent was installed to (C:\\Program Files\\Ganymede\\\<Connection Name\>).
