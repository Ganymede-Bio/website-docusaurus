...
The Chromatography app follows a streamlined workflow for comprehensive data analysis:

| **Step** | **Action** | **Description** |
|:--------:|-----------|-----------------|
| 1️⃣ | **Data Selection** | Access chromatography runs from Ganymede's data lake |
| 2️⃣ | **Peak Detection** | Automatic identification with machine learning algorithms |
| 3️⃣ | **Peak Editing** | Refine baselines, split peaks, and adjust boundaries |
| 4️⃣ | **Quality Control** | Review batch-to-batch consistency and control charts |
| 5️⃣ | **Validation** | Approve or reject peaks with documented reasoning |
| 6️⃣ | **Export to ELN** | Upload validated results to electronic lab notebook |
...
The Chromatography app transforms chromatography data analysis from a time-consuming manual process into an efficient, standardized workflow. To explore how the Chromatography app can be tailored to your specific analytical needs, contact your [Ganymede representative](mailto:support@ganymede.bio) or [our sales team to learn more](mailto:hello@ganymede.bio).
