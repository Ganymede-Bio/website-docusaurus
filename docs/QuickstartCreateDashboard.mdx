...
If you run into any challenges with the Quickstart, check out the [tips and tricks](./Dashboards#tips-and-tricks) section of the Dashboards page or [contact Ganymede Support](./Support.mdx).
