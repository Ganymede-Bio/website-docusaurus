...
|------------|------------------------|-----------------------------------------------------------------------|----------------|---------------|------------|
| API        | APINode                |                                                                       | NodeReturn     | True          | False      |
...
|------------|------------------------|------------------------------------------------------------------------------|
| API        | APINode                | Generic API Access Node                                                      |
...
| Analysis   | RunContainer           | FileAny                                                               | FileAny                                     | True          |
...
| App        | Benchling_Api          | API                                                                   | Table                                       | True          |
...
| App        | ELabNext_Write         | Table                                                                 | Table                                       | True          |
| App        | Load_Parquet_to_Table  | API                                                                   | FileAny                                     | False         |
| App        | S3_Event               | App                                                                   | FileAny                                     | True          |
| App        | S3_Read                | API                                                                   | FileAny                                     | False         |
| App        | S3_Write               | FileAny                                                               | API                                         | False         |
| App        | SciNote_Write          | Table                                                                 | Table                                       | True          |
...
| File       | Input_File             | FileAny                                                               | Table(s) and/or File(s)                     | True          |
| File       | Input_File_Multi       | Set[FileAny]                                                          | Table(s) and/or File(s)                     | True          |
...
| Instrument | Agilent_HPLC_Read      | File                                                                  | Dict[Table]                                 | True          |
