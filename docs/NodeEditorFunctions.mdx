...
- _param_ **run_id**: Optional[int] - If set, filters for results with specified run_id; useful for retrieving files associated with run ID of current run in a live setting
...
# Retrieves 2 files from the output bucket in the environment
