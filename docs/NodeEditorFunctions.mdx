...
_list_data_ lists files related to the _flow_

- _param_ **bucket**: str - Either "input" or "output" - to reference whether to observe the input or output bucket of the _flow_.
