...
Please reference [OpenAI policies](https://openai.com/policies) such as the [OpenAI data usage policy](https://openai.com/policies/api-data-usage-policies) prior to enabling this feature.
