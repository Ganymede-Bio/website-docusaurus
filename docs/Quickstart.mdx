...
Click on the <div className="button border_button"><NodeIndexOutlined /> **Flow Editor**</div> button in the sidebar.
...
Click on the <div className="button purple_button_navbar">**New** <PlusCircleOutlined /></div> button in the header bar and search for the term "excel" to filter for the relevant <div className="button dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Excel_Read**</div> *node*.  On the Flow diagram, select the <div className="button dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Excel_Read**</div> *node* and connect its top attachment point to the bottom attachment point of the <div className="button dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Flow_Inputs**</div> *node*.
...
Repeat this process with the <div className="button dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Transform_Py**</div> *node*.  Upon doing so, the <div className="button purple_button"><NodeIndexOutlined/> **Flow Editor**</div> window should look as follows:
...
By default, <div className="button dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Excel_Read**</div> treats the first row in the input file as the header row, so no modification is necessary for ingesting the sample file.

The <div className="button dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Transform_Py**</div> node needs to be modified to calculate absorbance difference.  To do so, open up the backing notebook for <div className="button dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Transform_Py**</div> by clicking on pencil icon (<EditOutlined className="button purple_button"/>) in the upper-right hand corner of the _node_.  This opens up the Jupyter notebook corresponding to the node in a separate tab on the browser.
