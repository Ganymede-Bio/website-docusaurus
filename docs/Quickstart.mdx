...
Click on the <div className="purple_button_navbar">**New <PlusCircleOutlined />**</div> button in the header bar and search for the <div className="dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Excel_Read**</div> *node*.  Select the <div className="dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Excel_Read**</div> *node* and connect the top attachment point of the <div className="dark_gray_button"><PlusCircleOutlined className="tree_node_icon"/> **Flow_Inputs**</div> *node* to the bottom attachment point of the Flow Inputs node.
