...
Navigate to the Environment Administration Panel by clicking on the gear icon in the top right corner of the Ganymede UI.
...
```python
from ganymede_sdk.api import GPT
