...
_retrieve_sql_ allows users to retrieve tabular data from the Ganymede data lake, preserving field names with special characters.
...
df_query1 = g.retrieve_sql(['table1', 'table2'])
```
