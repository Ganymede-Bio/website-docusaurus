...
The Ganymede SDK provides methods for interacting with File Tags from the Flow editor in `ganymede_sdk.file_tag`.  Configuration of Tag Types and access from Agents is detailed on the [Tagging Files](../connectivity/Tags) page.
