---
id: DebuggingAgents
title: Debugging Agents & FAQ
displayed_sidebar: webUiSidebar
---

This page describes a set of common questions and issues associated with configuring agents.
...
A: Yes, this can be done by referencing the `input_path` variable within the `kwargs` dictionary.  For example, to access the `input_path` variable, you can use the following code:
