...
Documentation on the objects used in the user-defined code for these agents can be found on the [Agent Data Models](../sdk/markdowns/AgentDataModels.mdx) page.
