...
Each iteration of the Agent’s build can be viewed in the History tab of the agent. This view provides context for each change, either in the form of a log of the configuration change or through a custom commit message from the Agent notebook.
