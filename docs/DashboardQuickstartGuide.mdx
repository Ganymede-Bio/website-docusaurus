...
title: Dashboard Quickstart Guide
...
This guide walks you through creating a _dashboard_ to visualize plate reader data ingested into Ganymede. This dashboard will leverage the same data ingested and processed in the original [Quickstart guide](https://docs.ganymede.bio/Quickstart). By the time you're finished, you'll have converted raw data to a dashboard that looks like this:

<div class="text--center">
<img width="800" alt="Absorbance Analytics Dashboard" src="https://ganymede-bio.mo.cloudinary.net/dashboard/absorbance_analytics_dashboard.png"/>
</div>
...
In order to create our dashboard we'll need two datasets, a **Quickstart_Absorbance_Change_Absolute_Differences** dataset and a **Quickstart_Absorbance_Change_Run_Parameters** dataset. To create a dataset, navigate to dashboards, hover over **Data**, and click **Dataset**.
...
<img alt="Dashboard - SQL Editor" src="https://ganymede-bio.mo.cloudinary.net/dashboard/Navigate_to_SQL_Editor.png" />
